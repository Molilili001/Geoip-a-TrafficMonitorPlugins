...
4. 开启梯子后，任务栏应显示形如 `US·Los Angeles`，鼠标提示包含 IP/ISP/ASN 等信息。右键任务栏打开的菜单里可以自由选择预设配置，也可以自己设置修改程序根目录下的Geoip.ini

ps. 本插件支持在主窗口（悬浮球）显示内容，但因为我不会做皮肤所以只能暂时放弃，只修改了皮肤10以暂时展示功能存在
